    ...
    class Meta:
        ...
        widgets = {
            ...
            'author': TextInput(attrs={'class': 'form-control',
                                      'placeholder': 'Please enter the product author'}),
            'description': Textarea(attrs={'class': 'form-control',
                                           'placeholder':'Please enter the product description'}),
            'price': forms.TextInput(attrs={'type': 'number', 'step': '0.01', 'min': '0.01'}),
            ...
            'dimensions_length': forms.NumberInput(attrs={'class': 'form-control',
                                               'placeholder': 'Please enter the product dimensions length'}),
            'dimensions_height': forms.NumberInput(attrs={'class': 'form-control',
